...
var defaultCallbacks = {
    successCallbacks: [function (t) {
        ...
        t.$(".yfForm.success-feedback").dequeue().fadeIn(100).delay(1800).fadeOut(100)
    }],
    ...
    saveSuccessCallbacks: [function (t) {
        t.$(".yfForm.save-block").dequeue().fadeIn(300).delay(1800).fadeOut(100);
    }],
